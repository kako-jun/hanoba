...
export const zh: Partial<Record<MessageKey, string>> = {
  ...
  "author.unnamed": "旅人",
  "card.readMore": "查看更多",
  "card.engagement.like": "添一朵花",
  "card.engagement.comment": "评论",
  "reaction.likes.aria": "{n} 朵花",
  ...
  "detail.likes.like.label": "添一朵花",
  "detail.likes.unlike.label": "已添花",
  "detail.likes.like.aria": "{n} 朵花。点击添一朵花。",
  "detail.likes.unlike.aria": "{n} 朵花。已添花，再次点击可收回。",
  "detail.likes.sending": "正在添花",
  "detail.likes.unsending": "正在收回花",
  "detail.likes.error": "未能添花，请重试。",
  "detail.likes.unlike.error": "未能收回花，请重试。",
  ...
  "edit.confirm.has.counts": "{likes} 朵花和 {comments} 条评论",
  "edit.confirm.has.suffix": "不会保留。",
  "edit.confirm.none": "原帖子的花和评论不会保留。",
  "edit.confirm.q": "确定吗？",
  "edit.back": "返回",
