...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "card.engagement.like": "Añadir una flor",
  "card.engagement.comment": "Comentar",
  "reaction.likes.aria": "{n} flores",
  ...
  "detail.likes.like.label": "Añadir una flor",
  "detail.likes.unlike.label": "Flor añadida",
  "detail.likes.like.aria": "{n} flores. Toca para añadir una flor.",
  "detail.likes.unlike.aria": "{n} flores. Ya añadiste una flor. Toca de nuevo para retirarla.",
  "detail.likes.sending": "Añadiendo una flor",
  "detail.likes.unsending": "Retirando tu flor",
  "detail.likes.error": "No se pudo añadir la flor. Inténtalo de nuevo.",
  "detail.likes.unlike.error": "No se pudo retirar tu flor. Inténtalo de nuevo.",
  ...
  "edit.confirm.has.counts":
    "{likes} flores y {comments} comentarios de esta publicación",
  "edit.confirm.has.suffix": " no se conservarán.",
  "edit.confirm.none":
    "Las flores y comentarios de la publicación original no se conservarán.",
