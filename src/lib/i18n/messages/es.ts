...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "detail.likes.like.aria": "{n} me gusta. Toca para dar me gusta.",
  "detail.likes.unlike.aria": "{n} me gusta. Toca de nuevo para quitar tu me gusta.",
  "detail.likes.sending": "Enviando Me gusta",
  "detail.likes.unsending": "Quitando tu Me gusta",
  "detail.likes.error": "No se pudo enviar. Inténtalo de nuevo.",
  "detail.likes.unlike.error": "No se pudo quitar tu Me gusta. Inténtalo de nuevo.",
