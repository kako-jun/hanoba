...
export const en: Partial<Record<MessageKey, string>> = {
  ...
  "detail.likes.like.aria": "{n} likes. Tap to like.",
  "detail.likes.unlike.aria": "{n} likes. Tap again to remove your like.",
  "detail.likes.sending": "Sending like",
  "detail.likes.unsending": "Removing your like",
  "detail.likes.error": "Could not send your like. Please try again.",
  "detail.likes.unlike.error": "Could not remove your like. Please try again.",
