...
export const ja = {
  ...
  "ranking.lead":
    "おっほん。ここは市勢調査所だ。諸君の投稿から、いま人気の品種を週ごとに集計しておる。先週との比較（↑↓・NEW・RE）つきだ。諸君の投稿がそのままチャートを動かすのだぞ。",
  ...
  // ヘッダ/フッタの /about ラベル（aboutLabel.ts・#262）。訪問者＝世界観の入口／市民＝自分の本。
  "about.label.visitor": "Hanōba とは",
  "about.label.citizen": "市民手帳",

  // ハノーバ市民手帳（cityHall.ts / CityHallBook・#163）。市長ボタニクス・フォン・ハノーバの声で語る「本」。
  "cityHall.book.title": "ハノーバ市民手帳",
  "cityHall.mayor.name": "ボタニクス・フォン・ハノーバ",
  ...
  "cityHall.ordinance.0.commentary":
    "育てる意志こそが地代だ。水をやり、葉を見つめる——それで諸君は十分に納めている。",
  ...
  // 記事は最古→最新で採番し、保存位置の無い初回だけ最終ページ（最新）を開く（#533）。
  ...
  // 記事4: 花リアクション・コメント解禁（#529/#530/#142/#537）。
  ...
  "gazette.articles.4.link.0.label": "みんなの植物を見る",
  // 記事5（最新）: 「もっと見る」で100件上限の先まで見られるようになった（#554）。
  "gazette.articles.5.heading": "見渡せる鉢を、もっと先まで",
  "gazette.articles.5.body.0":
    "おっほん。これまでは、一度に見渡せる鉢が百までであった。百鉢目より奥に眠っていた諸君の育てを、市長はずっと気にかけておった。",
  "gazette.articles.5.body.1":
    "そこで、三つの窓——表口、みんなの植物、あなたの植物——のいずれにも「もっと見る」を据えた。押せば、さらに奥の鉢まで歩いて行ける。",
  "gazette.articles.5.closing": "諸君の育てた鉢は、一つも忘れておらぬ。奥までしかと見て参れ。",
  "gazette.articles.5.link.0.label": "みんなの植物を見る",
  "gazette.articles.5.link.1.label": "あなたの植物を見る",
} as const;
