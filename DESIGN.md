...
- **フィード（読めるフィード・#34）**: hanoba の売り＝**本文を切らず全文表示し、読むのに1クリックも要らない**（vs Instagram）。縦並びカード＝正方形写真＋全文 caption（`whitespace-pre-wrap`・truncate しない）＋ハッシュタグ＋時刻。sm 以上＝写真左／本文右、モバイル＝写真上／本文下。**写真タップで拡大**（PostDetail モーダル）。植物タグで絞る。
